...
* 国际化配置
* */
niceShare.Constant.constant('LANGUAGE_PACKAGE', {
    // 中国
    CN : {
        language : '中文（简体）',
        login : '登录facebook',
        share : '现在分享',
        shareToFacebook : '转发到facebook',
        addPhoto : '点此添加图片文件',
        photoWarning : {
    ...
    TR : {
        language : 'Türkçe',
        login : 'Facebook ile Giriş Yap',
        share : 'Paylaş',
        shareToFacebook : 'Facebook’ ta Yayınla',
        addPhoto : 'Resim Ekle',
        photoWarning : {
    ...
    ES : {
        language : 'español',
        login : 'Log in Facebook',
        share : 'Compartir ahora',
        shareToFacebook : 'Reenviar a Facebook',
        addPhoto : 'Dar clic aquí para añadir foto',
        photoWarning : {
    ...
    PT : {
        ...
        share : 'Compartilhar',
        shareToFacebook : 'Compartilhe no Facebook ',
        addPhoto : 'Clique aqui para adicionar fotos',
        photoWarning : {
    ...
    US : {
        ...
        addPhoto : 'Click here to add photos',
        photoWarning : {
